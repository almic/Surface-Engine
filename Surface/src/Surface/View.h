...
namespace Surface {
	...
	public:
		...
		{
			// Set app as a courtesy, client doesn't have to use it
		...
		{
			OnDetach();
			// Do not unset app, the client should be allowed to keep it for later
			// If they really don't want it, they can unset app in OnDetach()
			// this->app = nullptr;
		}
